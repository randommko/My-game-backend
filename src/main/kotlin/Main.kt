...
fun main(args: Array<String>) {
    ...
    fun moveUnit(unitMap: HashMap<Coords, Unit?>, newCoords: Coords, oldCoors: Coords) {
    ...
    fun removeUnit(unitMap: HashMap<Coords, Unit>, unitCoords: Coords) {
